 ...
 */
public class WaterfallImageAdapter extends RecyclerView.Adapter<WaterfallImageAdapter.WaterfallViewHolder> {
    ...
    public void onBindViewHolder(@NonNull WaterfallViewHolder viewHolder, int position) {
        ...
        layoutParams.width = ScreenUtils.getScreenWidth(mContext) / 2 - SizeUtils.dp2px(mContext, 8);
        if (waterFallBean.getScale() != 0) {
            layoutParams.height = (int) (layoutParams.width / waterFallBean.getScale());
        }
        Glide.with(mContext)
